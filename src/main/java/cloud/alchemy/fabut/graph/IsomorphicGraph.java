...
public interface IsomorphicGraph {
     ...
     * @return - if graph contains object pair return {@link NodeCheckType}.CONTAINS_PAIR, if and only if one of the nodes is contained in nodes list return
     *     {@link NodeCheckType}.SINGLE_NODE, otherwise it is new pair and return {@link NodeCheckType}.NEW_PAIR.
     * @param <T> generic type
     */
